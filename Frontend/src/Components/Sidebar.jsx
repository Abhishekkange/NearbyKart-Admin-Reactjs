...
const Sidebar = () => {
    ...
    return <div>
        <div className="bg-black w-30 h-screen rounded-sm">
            <div className="text-center text-white font-semibold text-2xl pt-5 pb-4">
                NearbyKart
            </div>
            <div style={{height:'2px',background:'#323035'}}>

            </div>
            <div className="darkbrown mt-10 text-white text-lg">
                <div className={` ${openMenu1 && 'bg-blue-800 text-white'}`}>
                ...
                <div className={` ${openMenu2 && 'bg-blue-800 text-white'}`}>
                ...
                {openMenu2 && <div>
                    ...
                    <SubMenuButton name='Add Product' active={activeButton === 'bulkProduct'} onClick={() => handleButtonClick('bulkProduct')} />
            ...
            <div className="darkbrown  text-white text-lg">
                    <div className={` ${openMenu3 && 'bg-blue-800 text-white'}`}>
                ...
                {/* Other Menu */}
                <div className="darkbrown  text-white text-lg">
                    <div className={`p-1 ${openOtherMenu && 'bg-blue-800 text-white'}`}>
...
const SubMenuButton = ({ name, active, onClick }) => {
    return <div className={`pl-12 p-1 bg-black  ${!active ? 'text-gray-300' : 'text-white'}`}>
