...
const CategorySelector = () => {
  ...
  const fetchSubcategories = async () => {
    try {
      ...
      const response = await axios.get(`${baseApi}subcategory`, config);
  ...
  const handleCategoryChange = e => {
    ...
    const selectedCategoryObj = categories.find(category => category.categoryName === categoryN);
  ...
  const handleSubcategoryChange = e => {
    ...
    const selectedSubcategoryObj = subcategories.find(subcategory => subcategory.subcategoryName === subcategoryN);
