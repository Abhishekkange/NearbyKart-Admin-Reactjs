...
const AddBulkProduct = () => {
    ...
    return (
        <div className="flex flex-col">
            <div className="border-2 mt-4 p-1 border-black overflow-y-auto">
...
const ProductData = () => {
    const [clickedButton, setClickedButton] = useState('general');
    const [generalClicked, setgeneralClicked] = useState(true);
    const [inventoryClicked, setInventoryClicked] = useState(false);
    const [attributeCliked, useAttrubuteCliked] = useState(false);
    const [shortCLiked, setShortClicked] = useState(false);
    const [descriptionClicked, setDescriptionCkicked] = useState(false);
    ...
    const handleClick = (buttonName) => {
        ...
        setgeneralClicked(buttonName === "general" && !generalClicked);
        setInventoryClicked(buttonName === "inventory" && !inventoryClicked);
        useAttrubuteCliked(buttonName === "attributes" && !attributeCliked);
        setShortClicked(buttonName === "shortDescription" && !shortCLiked);
        setDescriptionCkicked(buttonName === "description" && !descriptionClicked);
    }

    return (
        <div className="mt-10 flex flex-shrink-0">
